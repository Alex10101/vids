  ...
  function addData() {
    for (let i = 0; i < videoData.length; i++) {
      arr.push({
        ...
        date: videoData[i].snippet.publishedAt.substr(
          0,
          videoData[i].snippet.publishedAt.indexOf('T')
        ),
    ...
    items: [
      {
        ...
        snippet: {
          ...
          description:
            'Official site: http://www.thebeatles.com Facebook: https://www.facebook.com/thebeatles/ Instagram: https://www.instagram.com/thebeatles Twitter: ...',
          thumbnails: {
            default: {
      ...
      },
      {
        ...
        snippet: {
          ...
          description:
            "[MV] GIRL'S DAY(걸스데이) _ Something (Dance ver.) LOEN MUSIC changes the name to '1theK[wʌnðəkeɪ]' to be a global K-POP hub! 로엔뮤직이 새 이름 ...",
          thumbnails: {
            default: {
      ...
      },
      {
        ...
        snippet: {
          ...
          description:
            "[MV] GIRL'S DAY(걸스데이) _ Something LOEN MUSIC changes the name to '1theK[wʌnðəkeɪ]' to be a global K-POP hub! 로엔뮤직이 새 이름 '1theK(원더 ...",
          thumbnails: {
            default: {
