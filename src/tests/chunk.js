...
function testChunk() {
    ...
    function singleNestedArrayTests() {
        ...
        function log1() {
            logTests(test1, test2, ["deferredMustBe", test2_1, deferredData]);
        }
    ...
    function multiNestedArrayTests() {
        ...
        function test2() {
            ...
            let test3 = test([1, 2, 3, 4, 5, 6, 7, 8], 3, [[7, 8, 1], [2, 3, 4], [5, 6, 7]]);
    ...
    function unemptyDeferredTests() {
        ...
        function unemptyDeferredTestsWithData() {
            ...
            function moreData() {
                deferredData = [1, 2, 3, 4];
                let deferredDataDump = [...deferredData];
                let test1 = test([5, 6, 7], 3, [[1, 2, 3], [4, 5, 6]]);
                let test1_1 = compareDeferred([]);
                let test1_2 = compareDeferred([3]);

                logTests(["deferredData", deferredDataDump], test1, ["deferredEmpty", test1_1], ["deferredMustBe", test1_2]);
            }
            ...
            function twoDeferred() {
                ...
                logTests(["deferredData", deferredData], test1, ["deferredEmpty", test1_1], ["deferredMustBe", test1_2]);
            }
        }
    }
}