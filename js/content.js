function contentConstructor(arr) {
  ...
  let sliders = {
    ...
    setActivePage: function() {
      ...
      slidersArr[
        this.activeSlider
      ].parent.className = this.activeSliderClassName;
  ...
  function appendElement(parent, index, data) {
    ...
    let DOMlinks = {
      link,
      img: createElement("img", "vids-img", { src: data.image }), // title: createElement('div', 'brief-title befored', {textContent: data.channelTitle}),
      title: createElement("div", "brief-title befored", {
        textContent: `i ${inc++} page ${page}`
      }),
      date: createElement("div", "brief-date befored", {
        textContent: data.date
      }),
      views: createElement("div", "brief-views befored", {
        textContent: fillDots(data.view_count)
      }),
      description: createElement("div", "vids-description", {
